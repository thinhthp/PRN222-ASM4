...
namespace zQuitSmoking.Repositories.ThinhTHP.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected SE18_PRN222_SE1809_G6_QuitSmokingDBContext _context;
        ...
        public GenericRepository(SE18_PRN222_SE1809_G6_QuitSmokingDBContext context)
        {
            _context = context;
        }
